...
|---|---:|---|
| Application | 5062 | http://192.168.1.249:5062/ |

Checkout: `/home/zageabb/flask/Heart`.

These are **user** systemd units. Inspect them with:

```bash
systemctl --user status migrated-flask@Heart.service
systemctl --user cat migrated-flask@Heart.service
```

Local verification URL: `http://127.0.0.1:5062/`. HTTP 200 was observed during this audit.
